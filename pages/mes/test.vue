    ...
    <view class="stats-section">
      <view class="stats-card">
        <view class="stats-item">
          <text class="stats-number">1280+</text>
          <text class="stats-label">政策</text>
        </view>
        <view class="stats-item">
          <text class="stats-number">856</text>
          <text class="stats-label">新闻</text>
        </view>
        <view class="stats-item">
          <text class="stats-number">124</text>
          ...
          <swiper-item>
            <scroll-view class="content-scroll" scroll-y="true">
              <view class="content-list">
                <view class="content-item" v-for="(item,index) in EventStore.eventing" :key="item.id" @click="onclickevent(item.id)">
